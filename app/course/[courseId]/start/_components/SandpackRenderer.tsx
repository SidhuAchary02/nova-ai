...
export default function SandpackRenderer({ language, initialCode }: SandpackRendererProps) {
  ...
  return (
    <div className="my-8 overflow-hidden rounded-xl border border-black/5 dark:border-white/10 dark:border-white/5 shadow-2xl">
      <div className="bg-nova-card px-4 py-2 border-b border-black/5 dark:border-white/10 dark:border-white/5 flex items-center justify-between">
