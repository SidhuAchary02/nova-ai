...
const PersonalizedRoadmapReview = ({
  ...
  return (
    <div className="space-y-10 rounded-2xl border border-white/10 bg-slate-950/50 p-6 shadow-[0_24px_80px_rgba(0,0,0,0.35)] sm:p-10">
      ...
      {/* Summary strip */}
      <div className="grid gap-4 rounded-2xl border border-white/10 bg-gradient-to-br from-slate-900/90 via-slate-950/80 to-slate-950 p-6 sm:grid-cols-3 sm:p-8">
        ...
        <div className="text-center sm:text-left">
          ...
          <p className="mt-2 text-3xl font-bold tabular-nums text-slate-50">
            {!hasDaily ? (
              ...
              <>
                <span className="text-slate-50">{dailyNumber}</span>
            ...
            <section key={phase.order} className="relative pl-10 sm:pl-12">
              ...
              <div className="rounded-2xl border border-white/10 bg-slate-900/50 p-5 sm:p-6">
                <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <span className="inline-flex w-fit rounded-full border border-white/10 bg-slate-950/80 px-3 py-1 text-xs font-medium text-slate-300">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          {strategy.skillGraph
            ...
            .map((s) => (
              <span
                key={`${s.order}-${s.skill}`}
                className="inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-slate-950/80 px-3 py-1.5 text-xs text-slate-200"
              >
